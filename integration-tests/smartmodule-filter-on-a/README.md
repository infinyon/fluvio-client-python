...
**This is just the source for the python integration tests**
...
$ cargo build --release
$ fluvio consume smartmodule-test -B --filter="target/wasm32-unknown-unknown/release/filter-ci-example"
```
